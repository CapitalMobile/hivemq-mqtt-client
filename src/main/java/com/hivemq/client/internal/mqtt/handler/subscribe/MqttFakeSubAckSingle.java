 ...
 * @author Silvio Giebl
 */
public class MqttFakeSubAckSingle extends Single<Mqtt5SubAck> {

    private final @NotNull MqttSubscribe subscribe;
    private final @NotNull MqttClientConfig clientConfig;

    public MqttFakeSubAckSingle(final @NotNull MqttSubscribe subscribe, final @NotNull MqttClientConfig clientConfig) {
    ...
    protected void subscribeActual(final @NotNull SingleObserver<? super Mqtt5SubAck> observer) {
        ...
        final MqttFakeSubscriptionHandler subscriptionHandler = clientComponent.fakeSubscriptionHandler();
